                        ...
                        @foreach( $ofertas as $key => $oferta )
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($oferta->estado == 'reparto')
                                        <a type="submit" class="btn btn-warning ediprodu" href="/oferta/{{ $oferta->id }}/entregada">Entregado</a>
                                    @else
                                        <a style="pointer-events: none;opacity: 0.5;" type="submit" class="btn btn-warning ediprodu" href="/oferta/{{ $oferta->id }}/entregada">Entregado</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
